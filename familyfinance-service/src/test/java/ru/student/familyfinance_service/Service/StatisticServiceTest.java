...
import ru.student.familyfinance_service.Repository.Implementation.ExpensesRepositoryImplementation;
import ru.student.familyfinance_service.Repository.Implementation.GrossBookRepositoryImplementation;
import ru.student.familyfinance_service.Repository.Implementation.IncomeRepositoryImplementation;
import ru.student.familyfinance_service.Repository.Implementation.PlanRepositoryImplementation;
import ru.student.familyfinance_service.Repository.Implementation.TargetRepositoryImplementation;
...
import ru.student.familyfinance_service.Service.Implementation.StatisticServiceImplementation;
...
public class StatisticServiceTest {
    ...
    public void ExpensesSheduleTest() {
        ...
        Map<LocalDate, Pair<Double, Double>> progress = Map.ofEntries(Map.entry(LocalDate.of(2025,2,8), Pair.of(800.0,800.0)),
                                                                    Map.entry(LocalDate.of(2025,2,15), Pair.of(0.0,0.0)),
                                                                    Map.entry(LocalDate.of(2025,2,22), Pair.of(0.0,0.0)),
                                                                    Map.entry(LocalDate.of(2025,2,28), Pair.of(0.0,0.0)));
